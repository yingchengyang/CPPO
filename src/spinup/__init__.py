...
from spinup.algos.pytorch.cvarvpg.cvarvpg import cvarvpg as cvarvpg_pytorch
from spinup.algos.pytorch.cvarppo.cvarppo import cvarppo as cvarppo_pytorch
